      ...
      >
        ...
        >
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  اختر الأدلة أو المعلومات التي أقنعتك بأن هذه الفرضية غير صحيحة
                </p>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="p-6 overflow-y-auto max-h-[50vh] space-y-6">
            {!hasAnyDiscoveries ? (
              <div className="text-center py-8">
                ...
                <p className="text-foreground font-medium mb-2">لم تجمع أي معلومات بعد</p>
                <p className="text-muted-foreground text-sm">
                  استكشف غرفة الأدلة، وتحدث مع الأشخاص، وحلل البيانات قبل استبعاد أي فرضية.
                </p>
              </div>
            ) : (
              <>
          ...
          <div className="p-6 border-t border-border flex items-center justify-between gap-4">
            ...
            >
              <X className="w-4 h-4" />
              <span>تأكيد الاستبعاد ({selectedItems.length})</span>
            </button>
          </div>
        </motion.div>
      </motion.div>
