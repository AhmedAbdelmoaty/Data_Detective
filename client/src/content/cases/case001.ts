  ...
  stakeholders: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          response:
            "من ناحية العدد هي أعلى بكتير. أما الجودة… ماكانش عندنا قياس واضح يفرق بين الاستفسار الجاد وغير الجاد.",
          cost: 10,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          response:
            "الضغط زاد جدًا. التليفونات شغالة طول اليوم، والفريق بيحاول يلحق… بس كتير من اللي بيتواصلوا مش بيكملوا للآخر.",
          cost: 10,
        },
        {
          id: "q2_2",
          ...
          response:
            "لا. نفس الفريق ونفس طريقة المتابعة تقريباً. الفرق الأساسي إن نوع الأسئلة بقى مختلف… أسئلة عامة كتير وأقل جدية.",
          cost: 10,
        },
      ],
    },
