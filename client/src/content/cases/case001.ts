  ...
  stakeholders: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          response:
            "السوق هادي الفترة دي… ناس كتير بتسأل وبتستطلع، بس مش بتاخد خطوة جد.",
          cost: 10,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          response:
            "الضغط زاد جدًا… التليفونات شغالة طول اليوم، والفريق بيحاول يلحق… بس ساعات مكالمات بتفوت.",
          cost: 10,
        },
        {
          id: "q2_2",
          ...
          response:
            "لا… نفس الفريق ونفس المتابعة زي ما هي، مفيش تغيير. بس اللي بيتواصلوا دلوقتي أغلبهم أسئلة عامة ومش ناوي يشتري فعلاً.",
          cost: 10,
        },
        {
          id: "q2_3",
          text: "في الفترة دي… الناس بتذكر منافس أو بتقارن بيننا وبينه؟",
