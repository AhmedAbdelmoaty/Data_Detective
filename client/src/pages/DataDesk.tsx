...
export default function DataDesk() {
  const { currentCase, discoverDataInsight, discoveredDataInsightIds, time } =
    useGameStore();
    ...
    <div className="p-8 space-y-8">
      <header className="flex justify-between items-end">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            شوف الرسوم والجداول… ولو لاحظت حاجة مهمة، سجّلها كرؤية.
          </p>
        </div>
      ...
      <div className="bg-card rounded-xl border border-border/50 p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          لما تلاحظ نمط مهم… اضغط “تسجيل” عشان يتسجل كمعلومة تستخدمها بعدين.
        </p>
